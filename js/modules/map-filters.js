...
import { recievedOffers } from './server-interfaces.js';
...
filtersElement.addEventListener('input', (_.debounce(() => updatePins(isOfferSuitable, recievedOffers), RENDER_DELAY)));
